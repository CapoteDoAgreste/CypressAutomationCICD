...
export const Sidebar: React.FC<SidebarProps> = ({ currentUser, currentView, onChangeView, onLogout }) => {
  const navItem = (view: ViewState, label: string, icon: React.ReactNode, perm?: PermissionCode) => {
    ...
    <div className="w-64 bg-white border-r border-gray-200 h-full flex flex-col">
      <div className="p-6 border-b border-gray-100">
        ...
        <div className="mt-4 p-2 bg-gray-50 rounded text-xs text-gray-500">
          User: <span className="font-semibold text-gray-700">{currentUser.username}</span>
          <br/>
